...
//        playPause.setOnClickListener(mButtonListener);
        ...
        pauseDrawable = ContextCompat.getDrawable(activity, R.mipmap.ic_pause_white_48dp);
        playDrawable = ContextCompat.getDrawable(activity, R.mipmap.ic_play_arrow_white_48dp);
