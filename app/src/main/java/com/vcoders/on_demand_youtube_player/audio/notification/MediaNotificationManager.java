...
import static com.vcoders.on_demand_youtube_player.audio.config.Config.ACTION_PREV;
...
//                Color.DKGRAY);
    ...
    {
        Intent openUI = new Intent(exoAudioService, HomeActivity.class);
    ...
    private Notification createNotification()
    {
        ...
        Intent clickIntent = new Intent(exoAudioService, HomeActivity.class);
...
//                .setColor(mNotificationColor)
                ...
                .setContentTitle(currentYouTubeVideo.getSnippet() != null ? currentYouTubeVideo.getSnippet().getTitle() : "")
                .setContentInfo(currentYouTubeVideo.getSnippet() != null ? currentYouTubeVideo.getSnippet().getDuration() : "")
                .setUsesChronometer(true)
                .setContentIntent(clickPendingIntent)
                .setSubText(Utils.getInstance().formatViewCount(currentYouTubeVideo.getContentDetails()==null?null:
        ...
        if (currentYouTubeVideo.getSnippet() != null&& currentYouTubeVideo.getSnippet().getThumbnails()!=null&&
            ...
            Picasso.with(exoAudioService)
                    .load(currentYouTubeVideo.getSnippet().getThumbnails().getMedium().getUrl())
