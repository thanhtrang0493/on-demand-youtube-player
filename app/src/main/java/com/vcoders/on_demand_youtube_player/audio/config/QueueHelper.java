package com.vcoders.on_demand_youtube_player.audio.config;
...
public class QueueHelper
{
    ...
    public static int getYouTubeVideoIndexOnQueue(Iterable<Video> queue,
                                                  String ytVideoId) {
        int index = 0;
    ...
    public static int getVideoIndexOnQueue(Iterable<Video> queue,
                                           String ytVideoId) {
        int index = 0;
        for (Video item : queue) {
            if (ytVideoId.equals(item.getId())) {
...
//    }
    ...
    public static boolean isIndexPlayable(int index, List<Video> queue) {
     ...
     *
     * @param list1 containing {@link Video}'s
     * @param list2 containing {@link Video}'s
     * @return boolean indicating whether the queue's match
     */
    public static boolean equals(List<Video> list1,
                                 List<Video> list2) {
        if (list1 == list2) {
            return true;
        }
     ...
     * @param youTubeVideo to compare to currently playing {@link Video}
