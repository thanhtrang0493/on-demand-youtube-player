...
public class GetPlaylistFromChannel1 extends InteractorYoutube1 {
    ...
    private static final GetPlaylistFromChannel1 ourInstance = new GetPlaylistFromChannel1();

    public GetPlaylistFromChannel1() {
    }

    public static GetPlaylistFromChannel1 getInstance() {
        return ourInstance;
    }

    public GetPlaylistFromChannel1 getPlaylistFromChannel(Context context, String channelId) {
    ...
    public GetPlaylistFromChannel1 onResponse(RequestAPIListener<List<PlayList>> listener) {
