...
public class SearchVideoByName1 extends InteractorYoutube1 {

    private static final SearchVideoByName1 ourInstance = new SearchVideoByName1();

    public static SearchVideoByName1 getInstance() {
        return ourInstance;
    }
    ...
    public SearchVideoByName1 searchVideoByName(Context context, String name) {
    ...
    public SearchVideoByName1 response(RequestAPIListener<List<VideoYoutube>> listener) {
